...
public class StudentsTableController implements Initializable {
	...
	private void viewCourse() {
		try {
			...
			AnchorPane a=FXMLLoader.load(getClass().getResource("Courses.fxml"));
		...
		if (s == null) {
			...
			public  Integer selectedStudent = s.getId();
	...
	private void login(ActionEvent event) {
		...
		try {
			...
			Parent root =  FXMLLoader.load(Main.class.getResource("/az/umammadov/Profile.fxml"));
